...
///////////////////////////////////////////////////////////////////////////////
Vector3 Trackball::getVector(int x, int y) const
{
...
///////////////////////////////////////////////////////////////////////////////
Vector3 Trackball::getUnitVector(int x, int y) const
{
    Vector3 vec = getVector(x, y);
    vec.normalize();
    return vec;
}
...
///////////////////////////////////////////////////////////////////////////////
Vector3 Trackball::getVectorWithArc(float x, float y) const
{
    float arc = sqrtf(x * x + y * y);   // length between cursor and screen center
...
///////////////////////////////////////////////////////////////////////////////
Vector3 Trackball::getVectorWithProject(float x, float y) const
{
    /*
